    ...
    <div class="container">
        <div class="panel panel-default credit-card-box" style="margin-top: 40px;">
            <div class="panel-heading display-table" style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <a href="{{ url('/') }}" class="btn btn-primary btn-md"><i class="fa-solid fa-house"></i>&nbsp;&nbsp;Home</a>
            </div>
        </div>
                ...
                <div class="panel panel-default credit-card-box">
                    ...
                    <div class="panel-body">
                        <form role="form" action="{{ route('stripe.store') }}" method="post" class="require-validation"
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <button class="btn btn-primary btn-md btn-block" type="submit"><i class="fa-solid fa-dollar-sign"></i>&nbsp;&nbsp;Pay Now</button>
                                </div>
                            </div>
                        </form>
                    </div>
